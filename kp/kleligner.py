...
workdir: '/proj/julianog/users/ChristianP/creWGS/kp/'
REF = '/proj/julianog/refs/KpMGH78578/KpMGH78578.fa'
readWD = '/proj/julianog/users/ChristianP/creWGS/kp/'
SAMPLES, = glob_wildcards('/proj/julianog/users/ChristianP/creWGS/kp/symlinks/{sample}_R1.fq.gz')
...
rule all:
	...
	input: 'variants/kp.pass.vcf'


rule select_variants :
	input: 'variants/kp.qual.vcf'
	output: 'variants/kp.pass.vcf'
	shell: 'java -jar {GATK} \
		-T SelectVariants \
...
rule filter_variants :
	input: vcf = 'variants/kp.vcf', depth = 'intervals/kp.5x@100%.intervals'
	output: 'variants/kp.qual.vcf'
	shell: 'java -jar {GATK} \
		-T VariantFiltration \
		-R {REF} \
		-V {input.vcf} \
...
rule filter_min_depth :
	input: 'variants/kp.vcf'
	output: 'intervals/kp.5x@100%.intervals'
